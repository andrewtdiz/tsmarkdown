...
const result1 = await executeMDXTemplate(compiled, {
...
console.log("\n=== Test 3: Empty list ===");
const result3 = await executeMDXTemplate(compiled, {}, {
  items: [],
}, "./mdx");
...
const listParsed = parseMDX(listContent);
const listCompiled = compileMDX(listParsed);
const result4 = await executeMDXTemplate(listCompiled, {}, {
...
const result5 = await executeMDXTemplate(listCompiled, {}, {
  items: ["First", "Second", "Third"],
  ordered: false,
}, "./mdx");
...
const commaListParsed = parseMDX(commaListContent);
const commaListCompiled = compileMDX(commaListParsed);
const result6 = await executeMDXTemplate(commaListCompiled, {}, {
  items: ["First", "Second", "Third"],
}, "./mdx");
console.log(result6.content);

console.log("\n=== Test 7: CommaList component test (empty) ===");
const result7 = await executeMDXTemplate(commaListCompiled, {}, {
  items: [],
  ordered: true,
}, "./mdx");
