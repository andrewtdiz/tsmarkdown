export const sidebar = [
  ...
  },
  {
    title: 'Syntax',
    links: [
      { href: '/template-interpolation', children: 'Dynamic Content', icon: 'Zap' },
      { href: '/conditional-rendering', children: 'Conditional Rendering', icon: 'GitBranch' },
      { href: '/react-components', children: 'React Components', icon: 'Component' },
  ...
  //   title: 'Examples',
  //   links: [
  //     { href: '/blog-example', children: 'Build a Blog' },
  //     { href: '/ecommerce-example', children: 'Product Page' },
  //     { href: '/docs-example', children: 'Documentation Site' },
