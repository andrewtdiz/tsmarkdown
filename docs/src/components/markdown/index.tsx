...
export const Heading2 = ({ children, className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h2
        className={cn("scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0 text-foreground", className)}
        {...props}
    >
        {children}
    </h2>
...
export const Blockquote = ({ children, className, ...props }: React.HTMLAttributes<HTMLQuoteElement>) => (
    <blockquote
        className={cn("mt-6 border-l-2 border-border pl-6 italic text-foreground/80", className)}
        {...props}
    >
        {children}
    </blockquote>
...
export const Code = ({ children, className, ...props }: React.HTMLAttributes<HTMLElement>) => (
    <code
        className={cn("relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm font-semibold text-foreground", className)}
        {...props}
    >
        {children}
    </code>
...
export const TableHead = ({ children, className, ...props }: React.ThHTMLAttributes<HTMLTableHeaderCellElement>) => (
    <th
        className={cn("border border-border px-4 py-2 text-left font-bold text-foreground [&[align=center]]:text-center [&[align=right]]:text-right", className)}
        {...props}
    >
        {children}
    </th>
...
export const AlertComponent = ({
    ...
    <Alert className={cn("my-4", className)} variant={variant} {...props}>
...
export const InfoCard = ({ title, children, className, ...props }: {
    ...
    <Card className={cn("my-4 border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950", className)} {...props}>
        {title && (
...
export const WarningCard = ({ title, children, className, ...props }: {
    ...
    <Card className={cn("my-4 border-yellow-200 dark:border-yellow-800 bg-yellow-50 dark:bg-yellow-950", className)} {...props}>
        {title && (
            <CardHeader className="pb-2">
...
export const ErrorCard = ({ title, children, className, ...props }: {
    ...
    <Card className={cn("my-4 border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-950", className)} {...props}>
        {title && (
            <CardHeader className="pb-2">
...
export const SuccessCard = ({ title, children, className, ...props }: {
    ...
    <Card className={cn("my-4 border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-950", className)} {...props}>
        {title && (
            <CardHeader className="pb-2">
...
// Export all components as a single object for Markdoc
